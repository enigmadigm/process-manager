            ...
            if (req.body && req.body.ref && typeof req.body.ref === "string") {
                if (req.body.ref === "refs/heads/master" || req.body.ref === "refs/heads/main") {// https://api.github.com/repos/enigmadigm/greenmesa/branches/master
                    ...
                    pm2.connect(async (err) => {
                        ...
                        if (req.body.repository.full_name.toLowerCase() === "enigmadigm/greenmesa") {
                        ...
                        if (req.body.repository.full_name.toLowerCase() === "galaxysh/ninjartzip") {
                            cp.exec(`${path.join(__dirname, "ninjartzip.sh")}`, (error, stdout, stderr) => {
                                if (error) {
                                    console.error(`exec error: ${error}`);
                                    return;
                                }
